...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"C:\Users\ASHISH PAL\Desktop\Face recognition system\all images\student 1.png")
        ...
        # second image
        img1=Image.open(r"C:\Users\ASHISH PAL\Desktop\Face recognition system\all images\student 2.png")
        ...
        # third image
        img2=Image.open(r"C:\Users\ASHISH PAL\Desktop\Face recognition system\all images\student 3.png")
        ...
        # bg image
        img3=Image.open(r"C:\Users\ASHISH PAL\Desktop\Face recognition system\all images\student bg.png")
        img3=img3.resize((100,70))
        ...
        current_course_frame.place(x=10,y=80,width=720,height=120)
        ...
        dep_combo["values"]=("Select Department","Computer Science","IT","Animation","Data Science")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","Fy","SY","TY","MSC l","MSC ll")
        ...
        year_combo["values"]=("Select Year","2021-22","2022-23","2022-23")
        ...
        class_Student_frame.place(x=5,y=200,width=800,height=350)
        ...
        div_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_div,font=("times new roman",12,"bold"),state="readonly",width=25)
        div_combo["values"]=("A","B","C")
        div_combo.current(0)
        div_combo.grid(row=1,column=1,padx=6,pady=3,sticky=W)
        ...
        gender_combo.grid(row=2,column=1,padx=6,pady=3,sticky=W)
        ...
        btn_frame.place(x=0,y=215,width=700,height=80)
        ...
        btn_frame1.place(x=0,y=255,width=700,height=40)
        ...
        img_right=Image.open(r"C:\Users\ASHISH PAL\Desktop\Face recognition system\all images\rigth frame.png")
        img_right=img_right.resize((740,80),Image.Resampling.LANCZOS)
        ...
        Search_frame.place(x=10,y=80,width=680,height=70)

        search_label=Label(Search_frame,text="Phone No:",font=("Search By:",15,"bold"),bg="white",fg="black")
        ...
        table_frame.place(x=10,y=170,width=680,height=350)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="root",port="3305",database="face_recognizer")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:       
                ...
                face_classifier=cv2.CascadeClassifier(r"C:\Users\ASHISH PAL\Desktop\tycsproject68\ashish\project68\haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path=r"C:\Users\ASHISH PAL\Desktop\tycsproject68\ashish\project68\data/user."+str(id)+"."+str(img_id)+".jpg"
